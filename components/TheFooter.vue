<template>
    <footer class="w-full py-4 text-sm italic text-center text-gray-400">
        ...
        <p>Public repository link <a class="underline" href="https://github.com/ercovi/schwarz-it" aria-label="View the public repository on GitHub" target="_blank">here</a></p>
    </footer>
</template>
