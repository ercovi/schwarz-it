...
useHead({
    title: `Magic cards Home Page - Page ${page.value}`,
    meta: [
        { name: 'description', content: 'Explore the magic cards and collect them.' },
        { name: 'robots', content: 'index, follow' },
        { property: 'og:title', content: `Magic Cards - Page ${page.value}` },
        { property: 'og:description', content: 'Explore the magic cards and collect them.' },
